...
class ProductObject(BaseObject):
    ...
    def camera(self):
        WebDriverWait(self.driver, 10).until(EC.visibility_of_element_located((By.XPATH, "//body/main[1]/div[1]/nav[1]/button[1]/i[1]")))
        camera_option = self.find_element((By.XPATH, "//body/main[1]/div[1]/nav[1]/button[1]/i[1]"))
        camera_option.click()
        WebDriverWait(self.driver, 10).until(EC.visibility_of_element_located((By.XPATH, "//body/main[1]/div[1]/nav[1]/div[2]/ul[1]/li[7]/a[1]")))
